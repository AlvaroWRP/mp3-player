...
export function Header({
    ...
    return (
        <header className="sticky top-0 z-10 flex flex-col gap-4 bg-neutral-900/90 backdrop-blur py-4 mb-6">
            ...
            <SearchBar searchQuery={searchQuery} onSearchChange={onSearchChange}></SearchBar>
        </header>
    );
}
